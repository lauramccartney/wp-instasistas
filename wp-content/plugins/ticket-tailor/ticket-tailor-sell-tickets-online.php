...
function tt_event_load($atts) {
    ...
    <script type="text/javascript"> jQuery( document ).ready(function() { jQuery(\'#'.$iframe_id.'\').iFrameResize({ checkOrigin: false  }); setTimeout("if(jQuery(\'#'.$iframe_id.'\').css(\'height\') == \'0px\') { jQuery(\'#'.$iframe_id.'\').css(\'height\',\'1500px\'); }",2000); }); </script>';
}
